          ...
          <div className="flex gap-2">
            {[1, 2, 3, 4].map((i) => (
              <div
                ...
                className="h-10 w-24 rounded bg-muted"
              />
            ))}
          </div>
    ...
    <div className="flex h-full flex-col space-y-8">
      ...
      <div className="dashboard-glass-card premium-noise p-4 md:p-6">
        ...
        <div className="mb-6 flex flex-wrap gap-2">
          <button
            ...
            className={
              filter === "all" ? "ui-button-primary" : "ui-button-muted"
            }
          >
            {t("all")} ({stats.total})
          </button>
                    ...
                    (_, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={
                            page === pageNum
                              ? "ui-button-primary px-3 py-2 text-sm"
                              : "ui-button-muted px-3 py-2 text-sm"
                          }
                        >
                          {pageNum}
                        </button>
        ...
        {selectedFile && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            />
            <div
              className="relative z-10 max-h-[90vh] w-full max-w-4xl overflow-hidden rounded-2xl bg-card/95 shadow-[0_24px_64px_rgba(0,0,0,0.35)]"
              role="dialog"
              aria-modal="true"
            >
              {/* Close button */}
      ...
      {deleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          />
          <div
            className="relative z-10 w-full max-w-md rounded-2xl bg-card/95 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.32)]"
            role="dialog"
            aria-modal="true"
          >
            <h3 className="text-lg font-semibold text-card-foreground">
