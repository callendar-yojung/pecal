...
export async function completePayPalWebhookEvent(eventId: string): Promise<void> {
  await pool.execute(
...
export async function releasePayPalWebhookEvent(eventId: string): Promise<void> {
  await pool.execute(
